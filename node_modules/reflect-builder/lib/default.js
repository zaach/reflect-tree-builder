...
var before = exports.before = function (base) { return base; }
...
var defaultProto = base.proto["_default"]||{};
...
var def = function def(Name, ini) {
    var name = Name[0].toLowerCase()+Name.slice(1);
    base.builder[name] = function (a,b,c,d,e,f,g,h) {
        ini.prototype = base.proto[name] || defaultProto;
        var obj = new ini(a,b,c,d,e,f,g,h);
        obj.type = Name;
        return obj;
    };
};
